...
import net.jsar.logicalga.nodes.NodeAND;
import net.jsar.logicalga.nodes.NodeNOT;
import net.jsar.logicalga.nodes.NodeOR;
    ...
    private Node makeNode(Random rng, int maxDepth)
    {
        if (functionProbability.nextEvent(rng) && maxDepth > 1)
        {
            ...
            */
            ...
            {
                case 0: return new NodeAND(makeNode(rng, depth), makeNode(rng, depth));
                case 1: return new NodeOR(makeNode(rng, depth), makeNode(rng, depth));
                default: return new NodeNOT(makeNode(rng, depth),null);
            }
        }
        ...
        else
        {
        	...
        	return new Constant(rng.nextInt(1));
        }
    }
    /*
    private Node makeNode(Random rng, int maxDepth)
