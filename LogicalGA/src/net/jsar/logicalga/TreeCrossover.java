...
public class TreeCrossover extends AbstractCrossover<Node>
{
     ...
     */
    @Override
    protected List<Node> mate(Node p1,
                              Node p2,
                              int numberOfCrossoverPoints,
                              Random rng)
    {
    	Node parent1 = (p1 instanceof MultipleNode) ? ((MultipleNode)p1).getChild(rng.nextInt(p1.getWidth())) : p1;
    	Node parent2 = (p2 instanceof MultipleNode) ? ((MultipleNode)p2).getChild(rng.nextInt(p2.getWidth())) : p2;
